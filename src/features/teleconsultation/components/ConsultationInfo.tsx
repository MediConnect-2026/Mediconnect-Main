...
export const ConsultationInfo = (props: ConsultationInfoProps) => {
  ...
  // Determine who to show in the info header based on the current user's role.
  // E.g., if Doctor, show Patient info. If Patient, show Doctor info.
